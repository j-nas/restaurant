const page = (() => {
  ...
  const bottomBar = () => {
    ...
    bottomBar.innerHTML = `<a href="https://github.com/j-nas" target="_blank"><span> Designed by Jon Naske </span><img src="./img/ghlogo.png" class="ghlogo" alt="" width="16" height="16"></a><`;
